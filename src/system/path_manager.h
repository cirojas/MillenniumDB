...
#include "query/executor/binding_iter/paths/experimental/multisource_bfs/ms_search_state.h"
...
#include "query/executor/binding_iter/paths/experimental/multisource_bfs/polaco/search_state.h"
...
public:
    ...
    static constexpr uint64_t ALL_SHORTEST_SIMPLE_MASK      = 0x00'0A'000000000000UL;
    static constexpr uint64_t ALL_SHORTEST_TRAILS_MASK      = 0x00'0B'000000000000UL;
    static constexpr uint64_t ANY_SHORTEST_WALKS_DIR_MASK   = 0x00'0C'000000000000UL;
    static constexpr uint64_t SHORTEST_K_SIMPLE_MASK        = 0x00'0D'000000000000UL;
    static constexpr uint64_t SHORTEST_K_TRAILS_MASK        = 0x00'0F'000000000000UL;
    static constexpr uint64_t SHORTEST_K_WALKS_MASK         = 0x00'10'000000000000UL;
    static constexpr uint64_t SHORTEST_K_GROUPS_SIMPLE_MASK = 0x00'11'000000000000UL;
    static constexpr uint64_t SHORTEST_K_GROUPS_TRAILS_MASK = 0x00'12'000000000000UL;
    ...
    ObjectId set_path(const Paths::ShortestKSimple::PathState* visited_pointer, VarId path_var);
    ObjectId set_path(const Paths::ShortestKTrails::PathState* visited_pointer, VarId path_var);
    ObjectId set_path(const Paths::ShortestKWalks::SearchState* visited_pointer, VarId path_var);
    ...
    ObjectId set_path(const Paths::Any::MSSearchStateSolution* visited_pointer, VarId path_var);
    ObjectId set_path(const Paths::AllShortest::MultiSourceSearchStateSolution* visited_pointer, VarId path_var);
