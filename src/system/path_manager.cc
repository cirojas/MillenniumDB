...
ObjectId PathManager::set_path(const Paths::ShortestKSimple::PathState* visited_pointer, VarId path_var)
{
    auto index = get_thread_index();
    paths[index][path_var.id] = visited_pointer;
    return ObjectId(ObjectId::MASK_PATH | SHORTEST_K_SIMPLE_MASK | path_var.id);
}

ObjectId PathManager::set_path(const Paths::ShortestKTrails::PathState* visited_pointer, VarId path_var)
{
    auto index = get_thread_index();
    paths[index][path_var.id] = visited_pointer;
    return ObjectId(ObjectId::MASK_PATH | SHORTEST_K_TRAILS_MASK | path_var.id);
}

ObjectId PathManager::set_path(const Paths::ShortestKWalks::SearchState* visited_pointer, VarId path_var)
{
    auto index = get_thread_index();
    paths[index][path_var.id] = visited_pointer;
    return ObjectId(ObjectId::MASK_PATH | SHORTEST_K_WALKS_MASK | path_var.id);
}

ObjectId PathManager::set_path(const Paths::ShortestKGroupsSimple::PathState* visited_pointer, VarId path_var)
{
    auto index = get_thread_index();
    paths[index][path_var.id] = visited_pointer;
    return ObjectId(ObjectId::MASK_PATH | SHORTEST_K_GROUPS_SIMPLE_MASK | path_var.id);
}

ObjectId PathManager::set_path(const Paths::ShortestKGroupsTrails::PathState* visited_pointer, VarId path_var)
{
    auto index = get_thread_index();
    paths[index][path_var.id] = visited_pointer;
    return ObjectId(ObjectId::MASK_PATH | SHORTEST_K_GROUPS_TRAILS_MASK | path_var.id);
}

ObjectId PathManager::set_path(const Paths::ShortestKGroupsWalks::SearchState* visited_pointer, VarId path_var)
{
    auto index = get_thread_index();
    paths[index][path_var.id] = visited_pointer;
