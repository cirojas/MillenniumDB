...
public:
    ...
    BindingExprCosineSimilarity(std::unique_ptr<BindingExpr> lhs, std::unique_ptr<BindingExpr> rhs) :
        lhs(std::move(lhs)),
        rhs(std::move(rhs))
    { }
    ...
    ObjectId eval(const Binding& binding) override
    {
        ...
        if (rhs_oid.generic_type() != ObjectGenType::Tensor) {
            return ObjectId::get_null();
        }
        ...
        case Conversions::OpType::TENSOR_FLOAT: {
            ...
            return Conversions::pack_float(lhs.cosine_similarity(rhs));
        }
        case Conversions::OpType::TENSOR_DOUBLE: {
            ...
            return Conversions::pack_double(lhs.cosine_similarity(rhs));
        }
