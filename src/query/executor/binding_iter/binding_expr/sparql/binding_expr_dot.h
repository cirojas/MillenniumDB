...
namespace SPARQL {
class BindingExprDot : public BindingExpr {
public:
    std::unique_ptr<BindingExpr> lhs;
    std::unique_ptr<BindingExpr> rhs;

    BindingExprDot(std::unique_ptr<BindingExpr> lhs, std::unique_ptr<BindingExpr> rhs) :
        lhs(std::move(lhs)),
        rhs(std::move(rhs))
    { }
    ...
    ObjectId eval(const Binding& binding) override
    {
        ...
        case Conversions::OpType::TENSOR_FLOAT: {
            ...
            return Conversions::pack_float(lhs.dot(rhs));
        }
        case Conversions::OpType::TENSOR_DOUBLE: {
            ...
            return Conversions::pack_double(lhs.dot(rhs));
        }
