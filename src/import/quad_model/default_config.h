...
inline void create_default_params(const std::string& db_folder)
{
    ...
    uint64_t ideal_versioned_pages_buffer_bytes = get_file_size(db_folder + "/from_to_label_edge.leaf")
                                                + get_file_size(db_folder + "/from_to_label_edge.dir")
                                                + get_file_size(db_folder + "/to_label_from_edge.leaf")
                                                + get_file_size(db_folder + "/to_label_from_edge.dir")
                                                + get_file_size(db_folder + "/label_to_from_edge.leaf")
                                                + get_file_size(db_folder + "/label_to_from_edge.dir")
                                                + get_file_size(db_folder + "/label_from_to_edge.leaf")
                                                + get_file_size(db_folder + "/label_from_to_edge.dir")
                                                + get_file_size(db_folder + "/edge_from_to_label.dir")
                                                + get_file_size(db_folder + "/edge_from_to_label.leaf")
    ...
    else if (ideal_strings_static_buffer_bytes + ideal_tensors_static_buffer_bytes + (ideal_versioned_pages_buffer_bytes / 3) <= target_ram)
    {
        strings_static_buffer = ideal_strings_static_buffer_bytes;
        tensors_static_buffer = ideal_tensors_static_buffer_bytes;
